                        ...
                        <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Vous êtes sur le point de supprimer cette prestation ? Cette action est irréversible !</p>
                            </div>
                        </div>
                    </div>
...
{{--                    </div>--}}
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button id="button_ras" type="button" class="rounded-md bg-red-50 px-3 py-2 text-sm font-semibold text-red-600 shadow-sm hover:bg-red-100">Supprimer la prestation</button>
            <button type="submit"
